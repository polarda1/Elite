...
def banner():
    print("\n%s    _________ __     \n%s   / ____/ (_) /____  ║ %sAuthor: %sRav Pratama XD.%s& %sWa:0838181011**\n%s  / __/ / / / __/ _ \ ║ %sFB %s: %sFacebook.com/RavXD\n%s / /___/ / / /_/  __/ ║ %sFB %s: %sRav Pratama\n%s/_____/_/_/\__/\___/  ║ %sGithub %s: %sGithub.com/RavXD\n"%(O,O,P,O,P,O,O,P,O,P,O,P,O,P,O,P,O,P))
def menu_log():
...
def menu():
    ...
    print('%s╠══[%s•%s] %sName : Rav Pratama%s'%(O,P,O,P,users))
    print('%s╠══[%s•%s] %sEmail : ravpratama211@gmail.com%s'%(O,P,O,P,maile))
